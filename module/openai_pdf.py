...
async def pdf(pdf_path, max_retries=3):
    ...
    8. Analyze the person's personality, tendencies, and characteristics in the PDF file, define words that can express these, and create within 5 words. Keywords must be words that can identify the personality, personality, and characteristics.
